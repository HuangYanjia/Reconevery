...
for filename, model in {
    ...
    "articulation_selected_identity.schema.json": ArticulatedSelectedIdentityManifest,
    "articulation_kinematic_bundle.schema.json": ArticulatedKinematicBundle,
    ...
    "scene_assembly_input_manifest.schema.json": SceneAssemblyInputManifest,
    "scene_assembly_lineage_report.schema.json": SceneAssemblyLineageReport,
    "scene_assembly_plan.schema.json": SceneAssemblyPlan,
    "scene_assembly_bundle.schema.json": SceneAssemblyBundle,
    "scene_assembly_overlap.schema.json": SceneAssemblyOverlapReport,
    "scene_assembly_compiler_manifest.schema.json": SceneAssemblyCompilerManifest,
    "scene_assembly_previews.schema.json": SceneAssemblyPreviewManifest,
    "phase6b_layered_scene_assembly.schema.json": Phase6BConsistencyReport,
}.items():
