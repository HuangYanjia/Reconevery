...
The isolated worker evaluates deterministic right-handed axis-rotation
initializations before trimmed Sim(3) ICP. This prevents common 90-degree arbitrary
COLMAP-frame differences from being trapped at the identity initialization while
preserving a proper positive-scale transform.
